Resource: https://youtu.be/BUlLSVgpMVg
...
Q: How can I implement fine-grained authorization with resolvers?

Q: Tell me more about AWS AppSync's real-time subscription model.

Q: How do bactch operations work for DynamoDB in AppSync?