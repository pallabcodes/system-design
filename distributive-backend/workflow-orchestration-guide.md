# Workflow Orchestration: The Principal Architect Guide

> **Level**: Principal Architect / SDE-3
> **Scope**: Airflow, Event-Driven Scheduling, and DAG Patterns.

> [!IMPORTANT]
> **The Principal Shift**: Move from **Time-Based** (Cron) to **Event-Based** (Triggers). Don't poll DBs every 5 minutes. Trigger DAGs immediately when an event lands in Kafka/SQS.

> **Source**: [Airflow 3.1 Event Triggers Explained](https://youtu.be/9dtT9eKe7hU)
