# Functional Domain Modeling: The Principal Architect Guide

> **Level**: Principal Architect / SDE-3
> **Scope**: Domain Driven Design (DDD), Type Systems, and Algebraic Data Types.

> [!IMPORTANT]
> **The Principal Concept**: **Make Illegal States Unrepresentable**. Don't write tests to check if `Email` is null. Design a type `VerifiedEmail` that *cannot* be null or invalid by construction.

> **Source**: [Domain Modeling Made Functional - Scott Wlaschin](https://youtu.be/MlPQ0FsPxPY)
